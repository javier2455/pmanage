...
| **I16** | **Un solo producto no lleva lámina**: viaja su propia foto y todo lo demás va en el texto | Acordado el 2026-08-24. La rejilla 2×2 con una sola celda deja media imagen en blanco. Sin lámina no hay maquetación que desperdiciar, y la foto conserva sus proporciones: no se recorta ni se rellena. Desde 2 productos, la composición actual |
...
| 2026-08-24 | Un producto suelto deja de componerse como lámina (I16). Se reencoda igualmente a JPEG —las fotos del bucket son WebP y WhatsApp las trataría como sticker— y se aplana sobre blanco, porque el WebP puede traer transparencia y el JPEG no tiene alfa: sin aplanar esos píxeles llegan en negro. El nombre, el negocio y la fecha pasan al texto, que es donde ahora viven. |
