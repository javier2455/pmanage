...
function DefaultLoader() {
  return (
    <div className="bg-oklch(1 0 0)/50 absolute inset-0 z-10 flex items-center justify-center backdrop-blur-xs dark:bg-oklch(0.145 0 0)/50">
      <div className="flex gap-1">
        <span className="bg-oklch(0.556 0 0)/60 size-1.5 animate-pulse rounded-full dark:bg-oklch(0.708 0 0)/60" />
        <span className="bg-oklch(0.556 0 0)/60 size-1.5 animate-pulse rounded-full [animation-delay:150ms] dark:bg-oklch(0.708 0 0)/60" />
        <span className="bg-oklch(0.556 0 0)/60 size-1.5 animate-pulse rounded-full [animation-delay:300ms] dark:bg-oklch(0.708 0 0)/60" />
      </div>
    </div>
  );
}
...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="focus-visible:ring-oklch(0.708 0 0) hover:bg-oklch(0.97 0 0) text-oklch(0.145 0 0) absolute top-0.5 right-0.5 z-10 inline-flex size-5 cursor-pointer items-center justify-center rounded-sm transition-colors focus:outline-none focus-visible:ring-2 dark:focus-visible:ring-oklch(0.556 0 0) dark:hover:bg-oklch(0.269 0 0) dark:text-oklch(0.985 0 0)"
    >
...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-oklch(1 0 0) text-oklch(0.145 0 0) relative max-w-62 rounded-md border border-oklch(0.922 0 0) p-3 shadow-md dark:bg-oklch(0.205 0 0) dark:text-oklch(0.985 0 0) dark:border-oklch(1 0 0 / 10%)",
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-oklch(0.145 0 0) text-oklch(1 0 0) pointer-events-none rounded-md px-2 py-1 text-xs text-balance shadow-md dark:bg-oklch(0.985 0 0) dark:text-oklch(0.145 0 0)",
        "animate-in fade-in-0 zoom-in-95 duration-200 ease-out",
        className,
      )}
    >
  ...
  return (
    <div
      className={cn(
        ...
        "text-oklch(0.145 0 0) text-[10px] font-medium dark:text-oklch(0.985 0 0)",
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-oklch(0.922 0 0) bg-oklch(1 0 0) [&>button:not(:last-child)]:border-oklch(0.922 0 0) flex flex-col overflow-hidden rounded-md border shadow-sm [&>button:not(:last-child)]:border-b dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(0.145 0 0) dark:[&>button:not(:last-child)]:border-oklch(1 0 0 / 10%)">
      {children}
    </div>
  );
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:bg-oklch(0.97 0 0) dark:hover:bg-oklch(0.97 0 0)/40 dark:hover:bg-oklch(0.269 0 0) dark:dark:hover:bg-oklch(0.269 0 0)/40",
        "focus-visible:ring-oklch(0.708 0 0) focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset dark:focus-visible:ring-oklch(0.556 0 0)",
